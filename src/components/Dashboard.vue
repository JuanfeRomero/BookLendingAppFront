        ...
        <v-row>
            <v-col sm="12">
                <v-alert v-if="responseSuccess" dense text type="success">
                    You hace successfully added book lending request.
                </v-alert>
            </v-col>
            <v-col sm="4">
                ...
                />
                <v-btn depressed color="default" @click="addBook">
                    Add Book
                </v-btn>
                <v-btn color="success" @click="lendBook">
                    Lend The Books
                </v-btn>
            </v-col>
            <v-col sm="8">
                    ...
                    <template v-slot:default>
                        ...
                        <tbody>
                            <tr v-for="book in selectedBooks" :key="book.id">
                                ...
                                <td>{{ book.isbn }}</td>
                                <td>
                                    <v-btn icon color="pink" @click="removeBook(book.id)">
